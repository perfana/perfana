...
export class BenchmarkMapper {
  ...
  static mapEntityToBenchmark(entity: BenchmarkEntity): Benchmark {
    return {
      ...
      evaluate_type: entity.evaluate_type || entity.configuration?.evaluateType,
      requirement_operator: entity.requirement_operator || entity.configuration?.requirement?.operator,
      requirement_value: entity.requirement_value ?? (entity.configuration?.requirement?.value != null ? Number(entity.configuration.requirement.value) : undefined),
