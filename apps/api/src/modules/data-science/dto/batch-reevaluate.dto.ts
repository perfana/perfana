...
export class BatchReevaluateDto {
  @ApiProperty({
    description: 'Array of test run IDs to reevaluate',
  ...
  @ApiProperty({
    description: 'Whether to run checks reevaluation',
    example: true,
    default: true,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Whether to run ADAPT analysis after reevaluation',
    example: true,
    default: true,
  })
  @IsOptional()
