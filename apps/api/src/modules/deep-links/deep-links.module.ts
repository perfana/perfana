...
import { DeepLink, GenericDeepLink, TestRunConfiguration, TestRun, SystemUnderTest } from '../../entities';

@Module({
  imports: [
    TypeOrmModule.forFeature([DeepLink, GenericDeepLink, TestRunConfiguration, TestRun, SystemUnderTest]),
