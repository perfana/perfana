...
export class TestRunsService {
  ...
  async getTransactionTimeSeries(testRunId: string, transactionName: string, userId: string, roles: string[], aggregationSeconds?: number, excludeRampUp: boolean = false) {
