...
const series = (id: string, metricName: string, panelTitle: string): TrendsSeries => ({
  id, metricName, panelTitle, dashboardId: 'd', dashboardLabel: 'Perf', panelId: 1, source: 'grafana',
});
