...
import { EditDeepLinkDialogProps } from './types';
import { useEditDeepLink } from './hooks';
import { AutocompletePopper, VariablesAccordion } from './components';
import { TagsInput } from '../shared/TagsInput';

export default function EditDeepLinkDialog({
  open,
  onClose,
  onSubmit,
  deepLink,
  ...
  const {
    ...
    handleSubmit,
    insertVariable,
  } = useEditDeepLink({ open, deepLink, systemName, onSubmit, onClose });
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle>
        ...
        <Typography variant="body2" color="text.secondary">
          Update URL link for {systemName} - {deepLink.testEnvironment} - {deepLink.workload}
        </Typography>
      </DialogTitle>
      ...
      <DialogActions>
        ...
        >
          {submitting ? 'Updating...' : 'Update Deep Link'}
        </Button>
      </DialogActions>
    </Dialog>
  );
...
export type { DeepLink, EditDeepLinkDialogProps } from './types';
