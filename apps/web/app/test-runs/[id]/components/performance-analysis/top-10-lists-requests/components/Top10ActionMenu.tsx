...
export function Top10ActionMenu({
  ...
  return (
    ...
    >
      <OpenInCardMenuItems series={item ? perfTestSeriesRef({ scenario: item.scenarioName, transaction: item.transactionName, sampler: item.requestName }) : null} onClose={onClose} />
