...
import { getTeamRoleLabel } from '@/lib/constants/roles';
import { AddMemberDialog } from '../organizations/AddMemberDialog';
import { EditMemberRolesDialog } from '../organizations/EditMemberRolesDialog';
      ...
      {members.length === 0 ? (
        <Box textAlign="center" py={6}>
          ...
          <Typography variant="body2" color="text.secondary" mb={3}>
            Add members to this team to collaborate on projects.
          </Typography>
          <Button
            variant="outlined"
            startIcon={<Add />}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            from this team? They will lose all access to team resources.
          </DialogContentText>
