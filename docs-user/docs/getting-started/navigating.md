...
3. Use the **Overview** group to monitor activity. It contains **Home** (KPIs and recently failed runs) and **Test Runs** (the full list of executions).
   You can now jump to your test results from either link.
4. Use the **Configuration** group to set things up. It contains **Systems Under Test**, **Integrations**, **Organizations**, **Teams**, **Settings**, **Profiles**, and **Audit Logs**.
   This is where you connect data sources and define what gets tested and measured.
5. At the bottom of the sidebar, use the **theme toggle** to switch between Light, Dark, and Auto appearance.
...
**Troubleshooting**
- *A page says you need to select an organization* — pick one from the **Organization** selector at the top of the sidebar before continuing.

**Related**
- [Find and filter test runs](../test-runs/find-and-filter-runs.md)
- [Read a test run](../test-runs/read-a-run.md)
