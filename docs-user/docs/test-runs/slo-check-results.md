...
2. Go to the **Service Level Objectives** section.
   ...
   ![The Service Level Objectives section listing checks with Pass or Fail results](../assets/run-slo.png)
   *Figure: Service Level Objectives - each check's requirement and Pass/Fail result.*
